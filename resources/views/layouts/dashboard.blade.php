    ...
    <nav>
        <div class="wrapper">
            ...
            <ul class="nav-links">
                ...
                <li>
                    <a href="#" class="desktop-item">User board</a>
                    <input type="checkbox" id="showDrop">
                    <label for="showDrop" class="mobile-item">User board</label>
                    <ul class="drop-menu">
                ...
                <li>
                    <a href="#" class="desktop-item">Post board</a>
                    <input type="checkbox" id="showDrop">
                    <label for="showDrop" class="mobile-item">Post board</label>
                    <ul class="drop-menu">
