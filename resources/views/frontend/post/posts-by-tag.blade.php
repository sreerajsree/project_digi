...
@section('meta')
    ...
    <meta property="og:image" content="http://digishaz.com/{{ Storage::url($posts_by_tag[0]->photo->path) }}">
    ...
    <meta property="twitter:image" content="http://digishaz.com/{{ Storage::url($posts_by_tag[0]->photo->path) }}">
