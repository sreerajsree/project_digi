...
@section('title', ucwords($chosen_tag->title) . ' - ' . 'Digishaz')
...
<div class="container pt-100">
    <div class="mvp-widget-home-head">
        <h4 class="mvp-widget-home-title"> <span class="mvp-widget-home-title">{{ preg_replace('~[^\p{M}\p{L}]+~u', ' ', $chosen_tag->title) }}</span></h4>
    </div>
    <div class="row">
        <div class="col-md-9">
